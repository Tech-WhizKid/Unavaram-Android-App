...
public class Receive extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    EditText mFullName,mDescription,phone;
    Button mSubmitBtn;
    FirebaseAuth fAuth;
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user.put("type",type);
                backup(fullname,description,geoPoint,userID,type,Phone);
                ...
                collectionReference.add(user)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                Log.d(TAG,"Success!");
                                FieldValue st = FieldValue.serverTimestamp();
                                Toast.makeText(getApplicationContext(), (CharSequence) st,Toast.LENGTH_SHORT).show();
    ...
    public void backup (String fullname, String description, GeoPoint geoPoint, String userID, String type, String Phone){
        userID = fAuth.getCurrentUser().getUid();
        //DocumentReference documentReference = fStore.collection("receiver").document(userID);
